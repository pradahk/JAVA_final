...
public class UserPatternDao {
     ...
     */
    public boolean insertOrUpdatePattern(UserPattern pattern) { // static 제거
        ...
        try (Connection conn = DBManager.getConnection(); // DBManager를 통해 연결 얻기
            ...
            int affectedRows = pstmt.executeUpdate(); // SQL 실행 및 영향을 받은 행의 수 반환
     ...
     */
    public UserPattern findPatternByUserId(int userId) throws SQLException { // static 제거, throws SQLException 추가
     ...
     */
    public boolean deletePatternByUserId(int userId) throws SQLException { // static 제거
